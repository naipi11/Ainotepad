...
The 26 px `base` rail uses short separators and muted text for configured cursor, encoding, newline, language, profile/model, message, and custom items. Only a suggested completion may use `ghost`.
