...
- Re-rendered the editor text layers with a single font, size, and baseline per language so the typed prefix, ghost continuation, line numbers, and code sample align consistently.
