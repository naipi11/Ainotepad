...
pub use engine::{CompletionEngine, CompletionMetrics, EngineEvent};
pub use openai::{
    completion_request_plan, completion_request_plan_for_request, endpoint_url, fetch_models,
    parse_model_ids, parse_sse_body, parse_stream_chunk, streaming_completion_request_plan,
    test_connection, AuthScheme, CompletionProtocol, OpenAiConfig, OpenAiTransport,
    ProfileRequestConfig,
};
pub use shape::{
    repair_unclosed_code_completion, shape_suggestion, shape_suggestion_for_context,
    shape_suggestion_for_language,
};
pub use snapshot::{
    take_snapshot, CompletionContext, CompletionMode, CompletionRequest, CompletionSnapshot,
};
