...
mod tests {
    ...
    fn editor_gutter_is_compact_and_uses_a_neutral_divider() {
        ...
        let input = egui::RawInput {
            screen_rect: Some(Rect::from_min_size(Pos2::ZERO, vec2(300.0, 160.0))),
            ..Default::default()
        };
    ...
    fn mixed_script_text_is_painted_as_one_line_galley() {
        ...
        let input = egui::RawInput {
            screen_rect: Some(Rect::from_min_size(Pos2::ZERO, vec2(600.0, 180.0))),
            ..Default::default()
        };
    ...
    fn editor_hover_uses_a_text_cursor() {
        ...
        let mut hovered_input = egui::RawInput {
            screen_rect: Some(Rect::from_min_size(Pos2::ZERO, vec2(300.0, 160.0))),
            ..Default::default()
        };
        hovered_input
